...
@Tag("theme-toggle")
@JsModule("./src/component/theme-toggle.js")
public class ThemeToggle extends Component implements ClickNotifier<ThemeToggle>, Focusable<ThemeToggle>, HasTheme,
        HasEnabled, HasSize, HasStyle, HasText, HasTooltip {
