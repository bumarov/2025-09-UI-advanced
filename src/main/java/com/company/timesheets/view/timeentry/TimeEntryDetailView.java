...
public class TimeEntryDetailView extends StandardDetailView<TimeEntry> {
    ...
    public void onQueryParametersChange(final QueryParametersChangeEvent event) {
        ownTimeEntry = event.getQueryParameters().getSingleParameter(PARAMETER_OWN_TIME_ENTRY)
                .isPresent();
    }
    ...
    TimeEntryStatus status = statusField.getValue();
        Icon icon = status == null
            ...
            case APPROVED -> {
                Icon newIcon = VaadinIcon.CHECK_CIRCLE_O.create();
                newIcon.setColor("var(--lumo-success-color)");
                yield newIcon;
            }
            case REJECTED -> {
                Icon newIcon = VaadinIcon.EXCLAMATION_CIRCLE_O.create();
                newIcon.setColor("var(--lumo-error-color)");
                yield newIcon;
            }
